...
'''
inputpath='~/Documents/pankoo_pata/pankoo_nopanota/ready_data_NOPANOTA_0630'
data=pd.read_csv(inputpath,index_col=False)
...
outputpath='~/Documents/pankoo_pata/pankoo_nopanota/ready_data_month_nopata_0630.csv'
